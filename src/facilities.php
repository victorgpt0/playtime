...
<div class="container" id="main-content">
    <div class="form-section">
        ...
        <form action="<?php print basename($_SERVER['PHP_SELF']); ?>" method="post" id="addFacilityForm">
            ...
            <input type="text" id="facilityName" name="facilityName" placeholder="Madaraka Football Arena#1" value="<?php print isset($_SESSION['facilityName']) ? $_SESSION['facilityName']: ''; unset($_SESSION['facilityName']);?>">
            ...
            <div id="otherFacility" style="display: <?php echo (isset($_SESSION['facilityType']) && $_SESSION['facilityType'] === 'Other') ? 'block' : 'none'; unset($_SESSION['facilityType']);?>;">
    <label for="otherFacilityType"><b>Please specify</b></label>
    <input type="text" id="otherFacilityType" name="otherFacilityType" value="<?php print isset($_SESSION['otherFacilityType']) ? $_SESSION['otherFacilityType']: ''; unset($_SESSION['otherFacilityType']);?>">
</div>

            <label for="description">Description</label>
            <input type="textarea" name="description" placeholder="7-a-side Football Turf" value="<?php print isset($_SESSION['description']) ? $_SESSION['description']: ''; unset($_SESSION['description']);?>">

            <label for="facilityPrice">Price per Hour:</label>
            <input type="number" id="facilityPrice" name="facilityPrice" placeholder="1500" value="<?php print isset($_SESSION['facilityPrice']) ? $_SESSION['facilityPrice']: ''; unset($_SESSION['facilityPrice']);?>">

            <input type="hidden" id="facilityLat" name="latitude" placeholder="Latitude" value="<?php print isset($_SESSION['latitude']) ? $_SESSION['latitude']: ''; unset($_SESSION['latitude']);?>" readonly />
            <input type="hidden" id="facilityLng" name="longitude" placeholder="Longitude" value="<?php print isset($_SESSION['longitude']) ? $_SESSION['longitude']: ''; unset($_SESSION['longitude']);?>" readonly />
            <input type="text" id="facilityAddress" name="address" value="<?php print isset($_SESSION['address']) ? $_SESSION['address']: ''; unset($_SESSION['address']);?>" placeholder="Address (Choose from the map below...)" readonly />
